...
export default function SignUpPage() {
    ...
    return (
        ...
        <div className="text-center">
            <button onClick={onSignUp} className='mt-4 bg-green-500 rounded-lg p-2 text-white'>{loading? "Loading" : "Sign Up"}</button>

            <br />
            <Link className='text-black' href="/Login">Visit to Sign In</Link>
        </div>
        </div>
    </div>
    </>
